...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, help='cfg file path',default='configs/dpose_conf_hands.yaml')
    ...
    parser.add_argument('--hand_ckpt', type=str, help='path to pretrained hand model checkpoint',default='data/ckpt/hands_with_agora.ckpt')
    parser.add_argument('--body_ckpt', type=str, help='path to pretrained body model checkpoint',default='data/ckpt/paper_arxiv.ckpt')
