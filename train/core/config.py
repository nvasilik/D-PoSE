...
DATASET_FOLDERS = {
    '3dpw-test-cam': 'data/3dpw/',
    '3dpw-sub-test': 'data/3dpw/',
    '3dpw-val-cam': 'data/3dpw/',
    ...
    'orbit-stadium-bmi': 'data/val_bedlam/20221019_3-8_250_highbmihand_orbit_stadium_6fps/png',
    ...
    '3dpw-train-smpl': 'data/3dpw',
    
    '3dpw-train-smplx': 'data/3dpw',
}

DATASET_FILES = [
    {
        '3dpw-test-cam': 'data/eval_data_parsed/3dpw_test.npz',
        '3dpw-sub-test': 'data/eval_data_parsed/3dpw_sub_test.npz',
        '3dpw-val-cam': 'data/eval_data_parsed/3dpw_validation.npz',
        'emdb': 'data/emdb/emdb_for_hmr2.npz',

        'rich': 'data/eval_data_parsed/rich_test.npz',
        'h36m-p1': 'data/eval_data_parsed/h36m_valid_protocol1.npz',
        'orbit-stadium-bmi': 'data/eval_data_parsed/all_npz_12_validation/20221019_3-8_250_highbmihand_orbit_stadium_6fps.npz',
...
DEPTH_FOLDERS ={
        ...
        'agora-bfh': '',
        'agora-body': '',
        'zoom-suburbd': 'data/bedlam_download/20221010_3-10_500_batch01hand_zoom_suburb_d/depth',#
        'closeup-suburba': 'data/bedlam_download/20221011_1_250_batch01hand_closeup_suburb_a/depth',#
        'closeup-suburbb': 'data/bedlam_download/20221011_1_250_batch01hand_closeup_suburb_b/depth',#
        'closeup-suburbc': 'data/bedlam_download/20221011_1_250_batch01hand_closeup_suburb_c/depth',#
        'closeup-suburbd': 'data/bedlam_download/20221011_1_250_batch01hand_closeup_suburb_d/depth',#
        'closeup-gym': 'data/bedlam_download/20221012_1_500_batch01hand_closeup_highSchoolGym/depth',#
        'zoom-gym': 'data/bedlam_download/20221012_3-10_500_batch01hand_zoom_highSchoolGym/depth',#
        'static-gym': 'data/bedlam_download/20221013_3-10_500_batch01hand_static_highSchoolGym/depth',#
        'static-office': 'data/bedlam_download/20221013_3_250_batch01hand_static_bigOffice/depth',#
        'orbit-office': 'data/bedlam_download/20221013_3_250_batch01hand_orbit_bigOffice/depth',#
        'orbit-archviz-15': 'data/bedlam_download/20221014_3_250_batch01hand_orbit_archVizUI3_time15/depth',#
        'orbit-archviz-19': 'data/bedlam_download/20221015_3_250_batch01hand_orbit_archVizUI3_time19/depth',#
        'orbit-archviz-12': 'data/bedlam_download/20221015_3_250_batch01hand_orbit_archVizUI3_time12/depth',#
        'orbit-archviz-10': 'data/bedlam_download/20221015_3_250_batch01hand_orbit_archVizUI3_time10/depth',#
        'static-hdri': 'data/bedlam_download/20221010_3_1000_batch01hand/depth',#
        'static-hdri-zoomed': 'data/bedlam_download/20221017_3_1000_batch01hand/depth',#
        'staticzoomed-suburba-frameocc': 'data/bedlam_download/20221017_1_250_batch01hand_closeup_suburb_a/depth',
        'zoom-suburbb-frameocc': 'data/bedlam_download/20221018_1_250_batch01hand_zoom_suburb_b/depth',#
        'static-hdri-frameocc': 'data/bedlam_download/20221018_3-8_250_batch01hand/depth',#
        'orbit-archviz-objocc': 'data/bedlam_download/20221018_3_250_batch01hand_orbit_archVizUI3_time15/depth',#
        'pitchup-stadium': 'data/bedlam_download/20221018_3-8_250_batch01hand_pitchUp52_stadium/depth',#
        'pitchdown-stadium': 'data/bedlam_download/20221018_3-8_250_batch01hand_pitchDown52_stadium/depth',#
        'static-hdri-bmi': 'data/bedlam_download/20221019_3_250_highbmihand/depth',#
        'closeup-suburbb-bmi': 'data/bedlam_download/20221019_1_250_highbmihand_closeup_suburb_b/depth',#
        'closeup-suburbc-bmi': 'data/bedlam_download/20221019_1_250_highbmihand_closeup_suburb_c/depth',#
        'static-stadium-bmi': 'data/bedlam_download/20221019_3-8_250_highbmihand_static_stadium/depth',
        'orbit-stadium-bmi': 'data/bedlam_download/20221019_3-8_250_highbmihand_orbit_stadium/depth',#
        'static-suburbd-bmi': 'data/bedlam_download/20221019_3-8_1000_highbmihand_static_suburb_d/depth',#
        'zoom-gym-bmi': 'data/bedlam_download/20221020_3-8_250_highbmihand_zoom_highSchoolGym_a/depth',#
        'static-office-hair': 'data/bedlam_download/20221022_3_250_batch01handhair_static_bigOffice/depth',#
        'zoom-suburbd-hair': 'data/bedlam_download/20221024_10_100_batch01handhair_zoom_suburb_d/depth',#
        'static-gym-hair': 'data/bedlam_download/20221024_3-10_100_batch01handhair_static_highSchoolGym/depth',#
}
...
MASK_FOLDERS ={
        ...
        'agora-bfh': '',
        'agora-body': '',
        'zoom-suburbd': 'data/masks/20221010_3-10_500_batch01hand_zoom_suburb_d/masks',#
        'closeup-suburba': 'data/masks/20221011_1_250_batch01hand_closeup_suburb_a/masks',#
        'closeup-suburbb': 'data/masks/20221011_1_250_batch01hand_closeup_suburb_b/masks',#
        'closeup-suburbc': 'data/masks/20221011_1_250_batch01hand_closeup_suburb_c/masks',#
        'closeup-suburbd': 'data/masks/20221011_1_250_batch01hand_closeup_suburb_d/masks',#
        'closeup-gym': 'data/masks/20221012_1_500_batch01hand_closeup_highSchoolGym/masks',#
        'zoom-gym': 'data/masks/20221012_3-10_500_batch01hand_zoom_highSchoolGym/masks',#
        'static-gym': 'data/masks/20221013_3-10_500_batch01hand_static_highSchoolGym/masks',#
        'static-office': 'data/masks/20221013_3_250_batch01hand_static_bigOffice/masks',#
        'orbit-office': 'data/masks/20221013_3_250_batch01hand_orbit_bigOffice/masks',#
        'orbit-archviz-15': 'data/masks/20221014_3_250_batch01hand_orbit_archVizUI3_time15/masks',#
        'orbit-archviz-19': 'data/masks/20221015_3_250_batch01hand_orbit_archVizUI3_time19/masks',#
        'orbit-archviz-12': 'data/masks/20221015_3_250_batch01hand_orbit_archVizUI3_time12/masks',#
        'orbit-archviz-10': 'data/masks/20221015_3_250_batch01hand_orbit_archVizUI3_time10/masks',#
        'static-hdri': 'data/masks/20221010_3_1000_batch01hand/masks',#
        'static-hdri-zoomed': 'data/masks/20221017_3_1000_batch01hand/masks',#
        'staticzoomed-suburba-frameocc': 'data/masks/20221017_1_250_batch01hand_closeup_suburb_a/masks',
        'zoom-suburbb-frameocc': 'data/masks/20221018_1_250_batch01hand_zoom_suburb_b/masks',#
        'static-hdri-frameocc': 'data/masks/20221018_3-8_250_batch01hand/masks',#
        'orbit-archviz-objocc': 'data/masks/20221018_3_250_batch01hand_orbit_archVizUI3_time15/masks',#
        'pitchup-stadium': 'data/masks/20221018_3-8_250_batch01hand_pitchUp52_stadium/masks',#
        'pitchdown-stadium': 'data/masks/20221018_3-8_250_batch01hand_pitchDown52_stadium/masks',#
        'static-hdri-bmi': 'data/masks/20221019_3_250_highbmihand/masks',#
        'closeup-suburbb-bmi': 'data/masks/20221019_1_250_highbmihand_closeup_suburb_b/masks',#
        'closeup-suburbc-bmi': 'data/masks/20221019_1_250_highbmihand_closeup_suburb_c/masks',#
        'static-stadium-bmi': 'data/masks/20221019_3-8_250_highbmihand_static_stadium/masks',
        'orbit-stadium-bmi': 'data/masks/20221019_3-8_250_highbmihand_orbit_stadium/masks',#
        'static-suburbd-bmi': 'data/masks/20221019_3-8_1000_highbmihand_static_suburb_d/masks',#
        'zoom-gym-bmi': 'data/masks/20221020_3-8_250_highbmihand_zoom_highSchoolGym_a/masks',#
        'static-office-hair': 'data/masks/20221022_3_250_batch01handhair_static_bigOffice/masks',#
        'zoom-suburbd-hair': 'data/masks/20221024_10_100_batch01handhair_zoom_suburb_d/masks',#
        'static-gym-hair': 'data/masks/20221024_3-10_100_batch01handhair_static_highSchoolGym/masks',#
}
...
hparams.DATASET.USE_DEPTH = True
hparams.DATASET.USE_DEPTH_CONC = True
hparams.DATASET.USE_SEGM = False
hparams.DATASET.USE_BG_DEPTH = False
hparams.DATASET.SUPERVISE_DEPTH = False
hparams.DATASET.SUPERVISE_SEGM = False
hparams.DATASET.ADVERSARIAL = False
hparams.DATASET.UPSAMPLE_HRNET = False
hparams.DATASET.DEPTH_ONLY = False
hparams.DATASET.USE_MULTIHEAD_ATTENTION = False
hparams.DATASET.COMPLETE_TRAIN = False
hparams.DATASET.VAL_INTERVAL = 1000
hparams.DATASET.DISC_DATASETS = ''
hparams.DATASET.RUN_NAME = 'default'
hparams.DATASET.OCCLUSION_PROB = 0.0
hparams.DATASET.DEPTH_MAP_SIZE = 224
# optimizer config
...
hparams.TRAINING.PRETRAINED_CKPT_BODY = None
hparams.TRAINING.PRETRAINED_CKPT_HANDS = None
