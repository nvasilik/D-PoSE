...
#Taken from PARE repository https://github.com/mkocabas/PARE
class KeypointAttention(nn.Module):
    def __init__(self, use_conv=True, in_channels=(720, 720), out_channels=(720,720), act='softmax', use_scale=False):# 256+48
        super(KeypointAttention, self).__init__()
        self.avgpool = nn.AdaptiveAvgPool2d(56)
    ...
    def forward(self, features, heatmaps,depth_maps=None):
        heatmaps = self.avgpool(heatmaps)
